...
class RoamingRalphDemo(ShowBase):
    def __init__(self):
        ...
        self.inst8 = addInstructions(0.42, "[Space]: Fire the snowball")
        ...
        self.accept("space", self.setKey, ["space-key", False])
    ...
    def move(self, task):
        ...
        if self.keyMap["forward"]:
            ...
            # self.snowball.setX(self.ralph.getX() + 90)
